...
- **Capture from anywhere:** any recipe web page, a YouTube video (title/description/
  ...
  card — the last two via Claude's vision. A single source can yield more than one
  recipe (e.g. a page with two recipes, or a video that walks through several dishes)
  and each becomes its own library entry.
